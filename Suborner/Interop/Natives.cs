...
namespace Suborner
{
    class Natives
    {
        ...
        extern public static int RegEnumKeyEx(UIntPtr hkey,
            uint index,
        ...
        public static extern int RegQueryInfoKey(UIntPtr hKey, [Out()] StringBuilder lpClass, ref uint lpcchClass,
           UIntPtr lpReserved, out int lpcSubkey, UIntPtr lpcchMaxSubkeyLen,
           UIntPtr lpcchMaxClassLen, UIntPtr lpcValues, UIntPtr lpcchMaxValueNameLen,
           UIntPtr lpcbMaxValueLen, UIntPtr lpSecurityDescriptor, UIntPtr lpftLastWriteTime);
        ...
        public static extern Int32 RegGetValue(
            UIntPtr hkey, 
            string lpSubKey, 
            string lpValue, 
            uint dwFlags, 
        ...
        public static extern uint RegSetValueEx(
             ...
             string lpValueName,
             uint Reserved,
             uint dwType, // Modified for user creation :)
             IntPtr lpData,
             int cbData);
